...
import com.hocrox.worldwidecdln.adapters.InventoryListAdapter
import kotlinx.android.synthetic.main.fragment_myinven_home.*

open class MyInventoryHomeFragment : MyInventoryBaseFragment(), NetworkConnection, View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var view = inflater?.inflate(R.layout.fragment_myinven_home, container, false)
        setData()
        return view
    }
    ...
    fun setAdapter() {
        ...
        var inventoryAdapter: InventoryListAdapter = InventoryListAdapter(activity, datalist, this)

        rl_inventorylist.layoutManager = LinearLayoutManager(activity)

        rl_inventorylist.adapter = inventoryAdapter

    }

    override fun connection() {

        replaceFragment(MyInventoryItemDetailFragment(), "My Inventory")

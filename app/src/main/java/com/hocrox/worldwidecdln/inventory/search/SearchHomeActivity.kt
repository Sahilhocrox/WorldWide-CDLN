package com.hocrox.worldwidecdln.inventory.search
...
class SearchHomeActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var fragment: Fragment = SearchHomeFragment()

        inflateFragment(fragment,resources.getString(R.string.inventorySearch))
    }
    ...
    companion object {
        ...
        lateinit var instance: SearchHomeActivity

        fun getInstances(): SearchHomeActivity {

...
open class MyInventoryBaseFragment : Fragment() {
    ...
    fun replaceFragment(fragment: Fragment,title:String){
        ...
        MyInventoryHomeActivity.getInstances().inflateFragment(fragment,title)

    }

    fun setToolbarText(name:String){

        MyInventoryHomeActivity.getInstances().setTitle(name)

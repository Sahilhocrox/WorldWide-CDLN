...
import com.hocrox.worldwidecdln.adapters.WatchListAdapter
import com.hocrox.worldwidecdln.inventory.sellingauction.fragments.SellingBaseFragment
import kotlinx.android.synthetic.main.fragment_sellingauction_home.*

open class WatchListHomeFragment : SellingBaseFragment(), NetworkConnection, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
   ...
   when(buttonView!!.id){
    ...
    fun setAdapter() {
        ...
        var watchListAdapter: WatchListAdapter = WatchListAdapter(activity, datalist, this)

        rl_sellinglist.layoutManager = LinearLayoutManager(activity)

        rl_sellinglist.adapter = watchListAdapter

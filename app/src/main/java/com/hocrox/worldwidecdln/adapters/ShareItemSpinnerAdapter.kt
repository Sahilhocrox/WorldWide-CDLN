 ...
 */
class ShareItemSpinnerAdapter(signUpActivity: FragmentActivity, val countries: Array<String>) : BaseAdapter() {


    var layout: LayoutInflater = LayoutInflater.from(signUpActivity)

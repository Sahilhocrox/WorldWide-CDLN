...
class SellingListAdapter(context: Context, val dataList: ArrayList<Any>, val fragment: Fragment) : RecyclerView.Adapter<SellingListAdapter.MyViewHolder>() {


    val layoutInflator: LayoutInflater = LayoutInflater.from(context)


    override fun onBindViewHolder(holder: SellingListAdapter.MyViewHolder?, position: Int) {
        ...
        holder.rootLayout.setOnClickListener {
                ...
                (fragment as SellingHomeFragment).connection()
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): SellingListAdapter.MyViewHolder {
        var view: View = layoutInflator.inflate(R.layout.custom_ratinglist, parent, false)

        return SellingListAdapter.MyViewHolder(view)
    }

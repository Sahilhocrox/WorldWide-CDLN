...
import com.hocrox.worldwidecdln.ridealong.RidePaymentInformationActivity

/**
 * Created by sahilgoyal on 6/7/17.
 */

class RideDriverListAdapter(paymentOptionActivity: Context, dataList: ArrayList<Any>) : RecyclerView.Adapter<RideDriverListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder?, position: Int) {
        ...
        holder.llRootName.setOnClickListener {
            ...
            context.startActivity(Intent(context, RidePaymentInformationActivity::class.java))
